...
const SHELL='nyc-ferry-did-shell-v80',DATA='nyc-ferry-did-data-v80';
const BASE=new URL(self.location.href).searchParams.get('base')||'/';
const FILES=[BASE,'/styles.css?v=80','/app.js?v=80','/assets/app-icon.png?v=80','/assets/app-icon-180.png?v=80','/assets/app-icon-192.png?v=80','/assets/app-icon-512.png?v=80','/assets/app-icon-maskable-512.png?v=80','/assets/site.webmanifest?v=80','/assets/kitty.png?v=80','/assets/waterway.png','/assets/seastreak.png','/assets/nyu.png','/assets/cityferry.png','/assets/gi.png','/assets/fonts/lato-regular-latin.woff2','/assets/fonts/lato-bold-latin.woff2','/assets/fonts/lato-black-latin.woff2','/assets/fonts/oswald-variable-latin.woff2'];
