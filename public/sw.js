...
const SHELL='nyc-ferry-did-shell-v70',DATA='nyc-ferry-did-data-v70';
const BASE=new URL(self.location.href).searchParams.get('base')||'/';
const FILES=[BASE,'/styles.css?v=70','/app.js?v=70','/assets/app-icon.png?v=70','/assets/app-icon-180.png?v=70','/assets/app-icon-192.png?v=70','/assets/app-icon-512.png?v=70','/assets/app-icon-maskable-512.png?v=70','/assets/site.webmanifest?v=70','/assets/waterway.png','/assets/seastreak.png','/assets/nyu.png','/assets/cityferry.png','/assets/gi.png','/assets/fonts/lato-regular-latin.woff2','/assets/fonts/lato-bold-latin.woff2','/assets/fonts/lato-black-latin.woff2','/assets/fonts/oswald-variable-latin.woff2'];
