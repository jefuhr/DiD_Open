...
export function nextDepartures({ index, stopId, now = new Date(), after = null, excludeTripId = null, limit = DEFAULT_LIMIT, updates = new Map(), vehicles = new Map(), stale = false }) {
    ...
    stops: calls.map((call) => {
      ...
      return {
        ...
        connections: nextDepartures({
          index, stopId: call.stopId, now, after, excludeTripId: tripId, limit, updates, vehicles, stale
        })
      };
    })
  };
