...
export const ROUTES = ["/healthz", "/api/health", "/api/landings", "/api/display-data", "/api/realtime", "/api/alerts", "/api/override", "/api/stats", "/stats", "/api/map", "/api/boats", "/map", STATIC_ROUTE, OTHER_ROUTE];
